...
// import { updateProfile } from '../../../../redux/slices/profile-slice/profileSlice';
		...
		<div
			...
			<form
				...
				<div className={cl.formItem}>
					...
					{newValues.date &&
						<img onClick={() => handleInputCloseClick('date')}
							className={cl.closeIcon} src={closeSvg} alt="" />}
				</div>
				<div className={cl.formItem}>
					<Input
						onChange={handleInputChange}
					...
					{newValues.languages &&
						<img onClick={() => handleInputCloseClick('languages')}
							className={cl.closeIcon} src={closeSvg} alt="" />}
				</div>
				<div className={cl.formItem}>
					<Input
					...
					{newValues.city &&
						<img onClick={() => handleInputCloseClick('city')}
							className={cl.closeIcon} src={closeSvg} alt="" />}
				</div>
