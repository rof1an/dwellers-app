...
export const Profile = () => {
	...
	const [data, setData] = useState<ProfileData>({ city: '', date: '', languages: '' })
		...
		<div>
			...
			<div className={cl.mainInfo}>
				<div className={cl.avatar}>
					...
					<input
						onChange={(e: React.ChangeEvent<HTMLInputElement>) => e.target?.files?.[0] && setSelectedFile(e.target?.files?.[0])}
